...
TOKEN=$(curl -s -H "Content-Type: application/json" -X POST -d '{"username": "'${TZDUSER}'", "password": "'${TZDPASS}'"}' https://hub.docker.com/v2/users/login/|jq -r .token)
RECURSE=true
THISURL=https://hub.docker.com/v2/repositories/tzdsystems/docker/tags/

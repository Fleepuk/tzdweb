...
NGINXLBCONF=/var/www/cgi-bin/tmp/tzdnginxlb.conf
...
chmod 777 ${THISPATH}/tmp/tzdnginxlb.conf
docker cp ${THISPATH}/tmp/tzdnginxlb.conf nginx:/etc/nginx/conf.d/tzdnginxlb.conf
